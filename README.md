...
Assuming the mod otherwise works fine, to fix the warning:
- Open the mod jar in a suitable extractor such as Winrar
- Extract `manifest.json`, and leave the window open
- Update the `ServerVersion` to the current release or pre-release
- Drag the updated `manifest.json` into the window, and bob's your uncle
